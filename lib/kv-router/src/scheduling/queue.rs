...
> SchedulerQueueActor<P, C, S, Sel, RF>
{
    ...
    fn admit_one(&self, mut request: SchedulingRequest, decay_now: Instant) {
        ...
        let response = SchedulingResponse {
            ...
            dp_strict_rank: selection.dp_strict_rank,
        };
        ...
        let sequence_request = SequenceRequest {
            ...
            prefill_load_hint,
            active_request_isl_tokens: self.track_active_request_isl.then_some(request.isl_tokens),
    ...
    /// Complete the tracked-admission ownership handoff.
    ///
    ...
    /// request lifetime and the caller must install its cleanup owner. If
